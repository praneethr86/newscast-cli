...
const questions_tech = [
  { 
    ...
    choices: [
      ...
      //   name: 'ReadWrite',
      //   value: 'readwrite'
      // }, //TODO: commenting as website has DDoS attack
      // {
      //   name: 'The Ken',
      //   value: 'ken'
      // }, //TODO: Need to fix the article reader then uncomment this
      {
...
function mainMenu() {
  inquirer
    .prompt(questions_categories)
    .then(answers => { 
      if(answers.category == 'eds') {
        inquirer
          .prompt(questions_editorials)
          .then(answers => {
              list('eds', {
