...
var science = require('./newssrc/science');
...
// Sports Hosts
var SPORTS_F1_ESPN_HOST = 'https://www.espn.in/f1/';
var SPORTS_F1_AUTOSPORT_HOST = 'https://www.autosport.com/f1';
...
var NEWYORKER_LATEST_HOST = 'https://www.newyorker.com/latest/news';
var FRONTLINE_LATEST_HOST = 'https://frontline.thehindu.com/the-nation/';
//Science
var SCIENCE_SCIAMERICAN_HOST =
  'https://www.scientificamerican.com/section/lateststories/';
// var SCIENCE_POPSCI_HOST = 'https://www.popsci.com/science/';
...
function getContent(modifier, value, cb) {
  if (modifier == 'eds') {
    ...
    if (value == 'economist') {
      ...
      magazines.magzNewYorker(NEWYORKER_LATEST_HOST, cb);
    } else if (value === 'frontline') {
      magazines.magzFrontline(FRONTLINE_LATEST_HOST, cb);
    }
  } else if (modifier === 'sports') {
    if (value == 'espnf1') {
      sports.sportsESPNF1(SPORTS_F1_ESPN_HOST, cb);
    } else if (value == 'autof1') {
      sports.sportsAutoSportF1(SPORTS_F1_AUTOSPORT_HOST, cb);
    } else if (value == 'epl') {
      sports.sportsEPL(SPORTS_EPL_HOST, cb);
    }
  } else if (modifier === 'science') {
    if (value == 'sciam') {
      science.sciSciAmerican(SCIENCE_SCIAMERICAN_HOST, cb);
    }
    // else if (value === 'popsci') {
    //   science.sciPopScience(SCIENCE_POPSCI_HOST, cb);
    // }
  }
}
