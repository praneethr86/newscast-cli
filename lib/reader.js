...
function parseContent(options) {
  ...
  // else if (options.modifier == 'yourstory') {
  //   if (options.website == 'social') {
  //     articleMarkup = $('.sc-jtRlXQ')
  //       .find('p')
  //       .text();
  //   }
  // }
  else if (options.modifier == 'projsyn') {
    if (options.website == 'all') {
      articleMarkup = $('.article__body')
        .find('p')
        .text();
    }
  } else if (options.modifier == 'hbr') {
    if (options.website == 'latest') {
      articleMarkup = $('.article')
        .find('p')
        .text();
    }
